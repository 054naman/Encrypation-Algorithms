...
//x dec r1 with x's privete key and send to y
//y check dec r1 with org r1 ->a authed

//x private->3 public->1
//y private->12 public->1
...
cout<<endl;
if(a1)
cout<<"Digital signature is verified and This means that Alice has Send the msg nobody else"<<endl;
else
